    ...
    sidebar: [
      {
        items: [
          ...
          { text: '总结', link: '/md/第一部分-基础知识/12总结' },
        ]
      },
    ],
    returnToTopLabel: '回到顶端',
    editLink: {
      pattern: 'https://github.com/Mq-b/Modern-Cpp-templates-tutorial',
      text: '在 GitHub 上编辑此页面'
    },
    socialLinks: [
      { icon: 'github', link: 'https://github.com/Mq-b/Modern-Cpp-templates-tutorial' },
    ]
  }
})
